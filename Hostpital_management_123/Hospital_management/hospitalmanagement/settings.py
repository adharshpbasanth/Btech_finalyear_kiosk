...
# https://docs.djangoproject.com/en/3.0/howto/static-files/
  # This defines the URL prefix for static files
MEDIA_URL = '/media/'    # This defines the URL prefix for media files
MEDIA_ROOT = BASE_DIR / 'media'  # Ensure MEDIA_ROOT points to a valid directory
